...
//TicketControl.prototype.sendPrintResults = function () {
//
//    nodePlatAssist.sentP02(function (err, backMsgNode) {
//
//    });
//};
            ...
            for (var i = 0; i < tickets.length; i++) {
                ...
                if (nodePlatCons.mode == 'test') {
                    if (tickets[i].gameCode == 'T53') {
                        ...
                        ticket.namedata = moment().add(1, 'days').format('YYMMDDHHmmss') + '-' + tickets[i].id + '-' + terminalDataUtil.gameCodeTrans[tickets[i].gameCode].code + '-' + terminalDataUtil.gameCodeTrans[tickets[i].gameCode].playType[tickets[i].playTypeCode + tickets[i].betTypeCode].tCode + '-00005005-' + tickets[i].amount;
